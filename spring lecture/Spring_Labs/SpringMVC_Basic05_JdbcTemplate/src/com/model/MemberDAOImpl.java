	...
	public MemberVO selectMemberById(String id) throws SQLException {
		...
		/*
            ...
            **아래 처리 자동화된 코드를 원하면 : select 컬럼명  == VO 객체 변수명이 같으면 된다
                          위의 작업을 한번에 해준다. 첫번째 parameter는 쿼리문 
                           		  query문 실행 -> resultset결과 담고 ->
                           	     두번째 parameter BeanPropertyRowMapper가 
	                           	 [Vo객체 생성 ->rs로 setter사용데이터 넣고]을 해준다.
	                           	 단, select컬럼명==vo객체 변수명이 같아야 한다.*********
	                    	     세번째 
