...
public class NewNoticeDao implements NoticeDao {
	...
	public int delete(String seq) throws ClassNotFoundException, SQLException {
		...
		String sql = "DELETE NOTICES WHERE SE";
	...
	public int insert(Notice n) throws ClassNotFoundException, SQLException {
		String sql = "INSERT INTO NOTICES(SEQ, TITLE, CONTENT, WRITER, REGDATE, HIT, FILESRC , FILESRC2) VALUES( (SELECT MAX(TO_NUMBER(SEQ))+1 FROM NOTICES), ?, ?, 'newleckosta', SYSDATE, 0, ?,?)";
