...
<%-- 					<c:if test="${empty pageContext.request.userPrincipal}">
					...
					<!-- 
						spring JSTL 처럼 VIEW 에서 사용할 수 있는 Script 를 가지고 있다
					security tag 이용하기 -->
				...
				<ul id="membermenu" class="clear">
					<li>
						<a href="${pageContext.request.contextPath}/mypage/confirm.htm"><img src="${pageContext.request.contextPath}/images/menuMyPage.png" alt="마이페이지" /></a>
					</li>
					<li>
