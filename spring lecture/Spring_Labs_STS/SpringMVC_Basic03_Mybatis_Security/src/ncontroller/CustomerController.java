...
public class CustomerController {
	...
	@RequestMapping(value="noticeReg.htm",method=RequestMethod.POST)
	public String noticeReg(Notice notice, HttpServletRequest request , Principal principal) throws IOException, ClassNotFoundException, SQLException {
		 //다중 파일 업로드
		   ...
		   //////////////////////////////////////////////////////////////
		   /////////////////security 처리 인증 사용자 정보 보기////////////////
		   /*1. 구체적인 정보 얻을 수 있다.
		   SecurityContext context = SecurityContextHolder.getContext();//security 설정에 대한 전체 정보를 가져온다.
		   Authentication auth = context.getAuthentication(); //인증 정보만 빼온다.
		   UserDetails userinfo = (UserDetails) auth.getPrincipal();  //권한 정보를 빼올 수 있다.
		   System.out.println(userinfo.getAuthorities()); //권한 정보를 빼올 수 있다.
		   System.out.println(userinfo.getUsername());
		   System.out.println(userinfo.getPassword());
		   
		   notice.setWriter(userinfo.getUsername());*/
		   
		   //2. 구체적인 정보를 얻을 수 없지만 Principal interface를 parameter로 주면 바로 사용해서 이름을 가져올 수 있다.
