			...
			<div class="top-wrapper">
				...
				<ul id="loginmenu" class="block_hlist">
					...
					<li>
					 ...
					 --%>
					 <%--Spring도 view에서 사용하는 script를 가지고 있다. --%>
					 <se:authorize access="!hasRole('ROLE_USER')">
					 	<li><a href="${pageContext.request.contextPath}/joinus/login.htm">로그인</a></li>
					 </se:authorize>
					 <se:authentication property="name" var="loginuser"/><!--name의 값을 loginuser에 저장 -->
				...
				<ul id="membermenu" class="clear">
					<li>
						<a href="${pageContext.request.contextPath}/joinus/memberupdate.htm"><img src="${pageContext.request.contextPath}/images/menuMyPage.png" alt="마이페이지" /></a>
					</li>
					<li>
